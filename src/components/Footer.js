export default () => {
    ...
    return (
        <footer className="text-gray-600 bg-white px-4 py-5 border-t-4 shadow-black max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <form 
                        onSubmit={(e) => e.preventDefault()}
                    >
                        <label className="block pt-10 pb-4">
                            Stay up to date
                        </label>
        ...
        <div className="mt-4 pt-2 border-t items-center justify-between sm:flex">
